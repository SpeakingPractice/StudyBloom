            ...
            <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
              ...
              <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-2xl border border-white/50">
                ...
                {selectedGameType === GameType.Grammar && (
                  <div className="mt-6">
                    <label className="block text-gray-700 font-bold mb-3 uppercase text-[10px] md:text-xs tracking-wider">Loại bài tập (Sub-skill)</label>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                      {Object.values(GrammarSubSkill).map((sub) => (
                        <Button key={sub} variant={selectedSubSkill === sub ? 'primary' : 'outline'} size="sm" onClick={() => setSelectedSubSkill(sub)}>
